...
const translations = {
    ru: {
        ...
        billingDetails: 'Реквизиты для счетов',
        ...
        cardNumberPlaceholder: '2200 1234 5678 9010',
        cardNumberHint: 'Показывается в портале клиента если включён чекбокс в его карточке',
        showCardInPortal: 'Показывать номер карты в портале клиента',
        cardForPayment: 'Реквизиты для оплаты',
        currencyAndRate: 'Валюта и ставка',
        currency: 'Валюта',
    ...
    en: {
        ...
        cardNumberHint: 'Shown in the client portal if enabled in the client card',
        showCardInPortal: 'Show card number in client portal',
        cardForPayment: 'Payment Details',
        currencyAndRate: 'Currency & Rate',
        currency: 'Currency',
